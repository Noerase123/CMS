...
switch($form_action){
	case 'ADD':
		...
		// $inser_post_data['room_title'] = $post_data['room_title'];
		// $inser_post_data['favicon'] = $post_data['favicon'];
		// $inser_post_data['logo'] = $post_data['logo'];
		// $inser_post_data['footer_logo'] = $post_data['footer_logo']; 	
		// $inser_post_data['room_description'] = $post_data['room_description']; 		
		...
		$post_activity_data['description'] = "<strong>".$post_data["room_title"]."</strong>";		
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_other_settings WHERE other_settings_id ='".$reference_id."'");
			...
			$edit_post_data['room_title'] = $post_data['room_title'];
			// if(!empty($post_data['favicon'])){
			// 	$edit_post_data['favicon'] = $post_data['favicon'];
			// }
			// if(!empty($post_data['logo'])){
			// 	$edit_post_data['logo'] = $post_data['logo'];
			// }
			// if(!empty($post_data['footer_logo'])){
			// 	$edit_post_data['footer_logo'] = $post_data['footer_logo'];
			// }
			// if(!empty($post_data['room_image'])){
			// 	$edit_post_data['room_image'] = $post_data['room_image'];
			// }
			// if(!empty($post_data['room_image2'])){
			// 	$edit_post_data['room_image2'] = $post_data['room_image2'];
			// }
...
foreach($editor_fields as $editor_fields_val){
	switch($editor_fields_val['type']){
		...
		break;
		case 'text_box':
			echo $form_object->text_box($editor_fields_val['label'],$editor_fields_val['field'],$is_editable_field,$record->$editor_fields_val['field'],$editor_fields_val['req'],$editor_fields_val['max'],$editor_fields_val['note']);
		break;
		case 'text':
		...
		break;
		case 'color_picker':
			echo $form_object->color_picker($editor_fields_val['label'],$editor_fields_val['field'],$is_editable_field,$record->$editor_fields_val['field'],$editor_fields_val['req'],$editor_fields_val['max'],$editor_fields_val['class'],$editor_fields_val['note']);
		break;
		case 'select':
