...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['ex_distance'] = $post_data['ex_distance']; 
		$inser_post_data['ex_location'] = $post_data['ex_location']; 
		$inser_post_data['ex_map'] = $post_data['ex_map']; 
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_explore WHERE ex_id ='".$reference_id."'");
			...
			$edit_post_data['ex_distance'] = $post_data['ex_distance'];
			$edit_post_data['ex_location'] = $post_data['ex_location'];
			$edit_post_data['ex_map'] = $post_data['ex_map'];
