...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['room_image'] = $post_data['room_image'];

		$inser_post_data['room_size'] = $post_data['room_size']; 	
		$inser_post_data['room_description'] = $post_data['room_description']; 	
		$inser_post_data['modal_description'] = $post_data['modal_description']; 		
	...
	case 'EDIT':
			...
			if(!empty($post_data['room_size'])){
				$edit_post_data['room_size'] = $post_data['room_size'];
			}
			if(!empty($post_data['room_image'])){
				$edit_post_data['room_image'] = $post_data['room_image'];
			}
			if(!empty($post_data['room_description'])){
