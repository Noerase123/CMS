...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['modal_title'] = $post_data['modal_title'];
		//$inser_post_data['modal_image'] = $post_data['modal_image']; 	
		...
		$post_activity_data['description'] = "<strong>".$post_data["modal_title"]."</strong>";		
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_dining_modal WHERE modal_id ='".$reference_id."'");
	...
	case 'DELETE':
		...
		if((strtoupper($_POST["Delete"]) == 'YES')){
			...
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_dining_modal WHERE modal_id ='".$reference_id."'");
			$modal_title = $sql_accommodations->modal_title;
			...
			$post_activity_data['description'] = "<strong>".$modal_title."</strong>";		
			$post_activity_data['date_updated'] = $post_data['date_updated'];
			$post_activity_data['ip_address'] = $_SERVER['REMOTE_ADDR'];			
			$result = $sql_helper->insert_all('tbl_activity_log',$post_activity_data);
