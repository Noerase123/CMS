...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['ex_title'] = $post_data['ex_title'];
		$inser_post_data['ex_image'] = $post_data['ex_image']; 
		$inser_post_data['recaptcha1'] = $post_data['recaptcha1']; 
		$inser_post_data['recaptcha2'] = $post_data['recaptcha2']; 
		$inser_post_data['booking_widget'] = $post_data['booking_widget']; 
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_other_settings2 WHERE ex_id ='".$reference_id."'");
			...
			$edit_post_data['ex_title'] = $post_data['ex_title'];
			$edit_post_data['recaptcha1'] = $post_data['recaptcha1'];
			$edit_post_data['recaptcha2'] = $post_data['recaptcha2'];
			$edit_post_data['booking_widget'] = $post_data['booking_widget'];

			if(!empty($post_data['ex_image'])){
				$edit_post_data['ex_image'] = $post_data['ex_image'];
			}
