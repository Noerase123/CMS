...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['promos_title'] = $post_data['promos_title'];
		$inser_post_data['promos_image'] = $post_data['promos_image'];
		// $inser_post_data['promos_modal_image'] = $post_data['promos_modal_image']; 	
		...
		$post_activity_data['description'] = "<strong>".$post_data["promos_title"]."</strong>";		
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_rooms WHERE room_id ='".$reference_id."'");
			...
			$edit_post_data['promos_title'] = $post_data['promos_title'];
			if(!empty($post_data['promos_image'])){
				$edit_post_data['promos_image'] = $post_data['promos_image'];
			}
			// if(!empty($post_data['promos_modal_image'])){
			// 	$edit_post_data['promos_modal_image'] = $post_data['promos_modal_image'];
			// }
	...
	case 'DELETE':
		...
		if((strtoupper($_POST["Delete"]) == 'YES')){
			...
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_rooms WHERE room_id ='".$reference_id."'");
			$room_title = $sql_accommodations->promos_title;
