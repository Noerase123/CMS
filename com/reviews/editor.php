...
switch($form_action){
	case 'ADD':
		...
		$inser_post_data['review_title'] = $post_data['review_title'];
		$inser_post_data['review_name'] = $post_data['review_name'];
		$inser_post_data['review_image'] = $post_data['review_image']; 	
		$inser_post_data['review_description'] = $post_data['review_description']; 		
	...
	case 'EDIT':
			...
			//ACTIVITY LOG
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_reviews WHERE review_id ='".$reference_id."'");
			...
			$edit_post_data['review_title'] = $post_data['review_title'];

			$edit_post_data['review_name'] = $post_data['review_name'];

			$edit_post_data['review_description'] = $post_data['review_description'];
			
			if(!empty($post_data['review_image'])){
				$edit_post_data['review_image'] = $post_data['review_image'];
			}
	...
	case 'DELETE':
		...
		if((strtoupper($_POST["Delete"]) == 'YES')){
			...
			$sql_accommodations = $db->get_row("SELECT * FROM tbl_review WHERE review_id ='".$reference_id."'");
