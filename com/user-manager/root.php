	...
	<?php 
		/*if ( isset($_GET['a']) && $_GET['a'] != '' ) { ?>
			...
			<div class="<?php echo $alert_type; ?>">
				<div class="message"><?php echo $helper->operation_msg($_GET['a'], $_GET['success'], "Record")?></div>
			</div>
		</div>
	<?php 
		}*/ 
						...
						<table class="table table-striped table-bordered table-hover" id="dataTables-example">
							...
							<tbody>
								...
								foreach($result_list as $result_list_val){
									...
									$email_address	= $result_list_val->email_address;
									$user_role_id	= $result_list_val->user_role_id;

									
									//Getting User Role title
									$result_list_2	=	$db->get_results("SELECT * FROM ".$table_user_role." WHERE user_role_id = ".$user_role_id."");
									foreach($result_list_2 as $result_list_val_2){
								...
								?>
									<tr class="odd gradeX">
										...
										<td><?php echo $user_role_title; ?></td>
